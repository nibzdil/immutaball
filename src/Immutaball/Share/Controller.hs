...
takeAllSDLEventsList :: IBContext -> ([Event] -> ImmutaballIO) -> ImmutaballIO
takeAllSDLEventsList cxt withEvents =
...
takeAllSDLEvents = takeAllSDLEventsIndividually
