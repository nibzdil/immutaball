...
fragmentShader = unlines $
	[
		...
		"\tfragmentColor = ",
		"\t\tvertexTexLayer ==  0 ? texture(texture0,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  1 ? texture(texture1,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  2 ? texture(texture2,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  3 ? texture(texture3,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  4 ? texture(texture4,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  5 ? texture(texture5,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  6 ? texture(texture6,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  7 ? texture(texture7,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  8 ? texture(texture8,  vertexTexCoords) :",
		"\t\tvertexTexLayer ==  9 ? texture(texture9,  vertexTexCoords) :",
		"\t\tvertexTexLayer == 10 ? texture(texture10, vertexTexCoords) :",
		"\t\tvertexTexLayer == 11 ? texture(texture11, vertexTexCoords) :",
		"\t\tvertexTexLayer == 12 ? texture(texture12, vertexTexCoords) :",
		"\t\tvertexTexLayer == 13 ? texture(texture13, vertexTexCoords) :",
		"\t\tvertexTexLayer == 14 ? texture(texture14, vertexTexCoords) :",
		"\t\tvertexTexLayer == 15 ? texture(texture15, vertexTexCoords) :",
