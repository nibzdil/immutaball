...
vertexShader = unlines $
	[
		...
		"\tbool p2 = whichPoint == 2;",
		"\tbool p3 = whichPoint == 3;",
		"",
		"\tint innerDivision = whichDivision % divisionsInOneCol + (p2 || p3 ? 1 : 0);",
		"\tint outerDivision = whichDivision / divisionsInOneRow + (p1 || p3 ? 1 : 0);",
		"",
		"\t// 4 points for 3 triangles: inner p0, inner p1, outer p0, outer p1.",
		...
		"vec4 rawPos = vec4(ballRadius*vec3(innerx, innery*outerx, innery*outery), 1.0);  // Untransformed.",
		"",
