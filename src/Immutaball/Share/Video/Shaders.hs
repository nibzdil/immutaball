...
vertexShader = unlines $
	[
		...
		"\tfloat circleSample     = float(whichCircleSample) / squaresInOneCircle;  // 0.0 represents the start of the circle; 1.0 represents 360 degrees.",
		"\tfloat tilt             = float(whichTilt)         / numTilts;            // 0.0 represents the first tilt; 1.0 represents all tilts are done.",
