...
fragmentShader = unlines $
	[
		...
		-}
		-- TODO debug!
		"\t\tvertexTexLayer ==  0 ? texture(texture0,  vertexTexCoords) * vertexModulateColor + vec4(0.5, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  1 ? texture(texture1,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.5, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  2 ? texture(texture2,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.5, 0.3) :",
		"\t\tvertexTexLayer ==  3 ? texture(texture3,  vertexTexCoords) * vertexModulateColor + vec4(0.5, 0.5, 0.5, 0.3) :",
		"\t\tvertexTexLayer ==  4 ? texture(texture4,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.3, 0.3, 0.3) :",
		"\t\tvertexTexLayer ==  5 ? texture(texture5,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  6 ? texture(texture6,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  7 ? texture(texture7,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  8 ? texture(texture8,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer ==  9 ? texture(texture9,  vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 10 ? texture(texture10, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 11 ? texture(texture11, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 12 ? texture(texture12, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 13 ? texture(texture13, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 14 ? texture(texture14, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
		"\t\tvertexTexLayer == 15 ? texture(texture15, vertexTexCoords) * vertexModulateColor + vec4(0.1, 0.1, 0.1, 0.3) :",
